...
/** @type {((vendor: string, sourceEmail: string, date: string) => { type: "empty-extraction-skipped" } & Record<string, any>) & { type: "empty-extraction-skipped" }} */
export const emptyExtractionSkipped = defineEvent("empty-extraction-skipped", "vendor", "sourceEmail", "date");

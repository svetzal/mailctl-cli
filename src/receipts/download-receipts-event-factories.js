 ...
 * typedef, union, renderer, or export-list edit needed — `receiptEvents` and
 * `renderDownloadReceiptsEvent` are both derived from TABLE.
 */
...
export const receiptEvents = factories;
